...
public class Printls_VS_Print2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hello everyone? How are you all today? Today we will learn Escape Sequences, and next week we will learn Veriables");
